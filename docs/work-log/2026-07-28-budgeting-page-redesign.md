...
- All 9 categories with nonzero FY2025 activity matched the rendered "Prior Actual" cell exactly: Public donations $X,XXX.XX, Grants received $X,XXX.XX, Rudolph Run $XX,XXX.XX, Grant out $X,XXX.XX, Charitable donation out $XX,XXX.XX, Program supplies $XXX.XX, Fundraising event costs $XX,XXX.XX, Insurance & bonding $XXX.XX, Scholarships $X,XXX.XX. The remaining 7 categories with zero FY2025 activity correctly show "$0.00" (actual is a sum, defaults to 0) rather than "—".
