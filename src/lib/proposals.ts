...
// B-46 consolidation (2026-09-11): the local escapeProposalHtml() that used
// to live here is gone. It was byte-identical to src/lib/html-escape.ts's
// escapeHtml() (minus the apostrophe escape html-escape.ts has since
// gained) — every caller now imports escapeHtml from "@/lib/html-escape"
// directly. See docs/reviews/2026-09-10-code.md HIGH-1.
